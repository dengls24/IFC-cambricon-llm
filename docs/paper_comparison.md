...
|---|---|---:|---:|---:|
| OPT-6.7B | Cambricon-LLM-S | 3.600000 | 3.663151 | 1.754% |
| OPT-6.7B | Cambricon-LLM-M | 11.000000 | 10.073148 | -8.426% |
| OPT-6.7B | Cambricon-LLM-L | 36.300000 | 31.104766 | -14.312% |
| OPT-13B | Cambricon-LLM-S | 1.900000 | 1.876975 | -1.212% |
| OPT-13B | Cambricon-LLM-M | 4.700000 | 5.261630 | 11.950% |
| OPT-13B | Cambricon-LLM-L | 14.200000 | 16.031076 | 12.895% |
| OPT-30B | Cambricon-LLM-S | 0.800000 | 0.798864 | -0.142% |
| OPT-30B | Cambricon-LLM-M | 2.500000 | 2.315097 | -7.396% |
| OPT-30B | Cambricon-LLM-L | 7.600000 | 6.743696 | -11.267% |
| OPT-66B | Cambricon-LLM-S | 0.400000 | 0.350199 | -12.450% |
| OPT-66B | Cambricon-LLM-M | 1.200000 | 1.061912 | -11.507% |
| OPT-66B | Cambricon-LLM-L | 2.600000 | 2.842984 | 9.346% |
| LLaMA2-7B | Cambricon-LLM-S | 3.600000 | 3.641585 | 1.155% |
| LLaMA2-7B | Cambricon-LLM-M | 10.400000 | 10.013449 | -3.717% |
| LLaMA2-7B | Cambricon-LLM-L | 34.000000 | 30.865517 | -9.219% |
| LLaMA2-13B | Cambricon-LLM-S | 1.900000 | 1.876975 | -1.212% |
| LLaMA2-13B | Cambricon-LLM-M | 4.700000 | 5.261630 | 11.950% |
| LLaMA2-13B | Cambricon-LLM-L | 14.000000 | 16.031076 | 14.508% |
| LLaMA2-70B | Cambricon-LLM-S | 0.300000 | 0.337002 | 12.334% |
| LLaMA2-70B | Cambricon-LLM-M | 1.000000 | 1.043976 | 4.398% |
| LLaMA2-70B | Cambricon-LLM-L | 3.400000 | 2.912732 | -14.331% |

Interpretation: this scheme is the only path that should be described as directly reproducing the paper's Figure 9 decode-speed result. It is within 8.356% mean absolute relative error over the 21 paper points. The default 1K context is an inverse-fit setting supported by the Figure 9 sweep, not a field that the paper text explicitly states for Figure 9.
