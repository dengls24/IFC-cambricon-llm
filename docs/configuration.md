...
`make hw-cycle`, `make systemc-cycle`, and `make systemc-component` also accept the active platform CSV through:
...
bin/ifc_component_systemc --platforms-csv configs/default_platforms.csv
```
