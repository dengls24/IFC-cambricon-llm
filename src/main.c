...
int main(int argc, char **argv) {
    ...
    printf("operator_trace_csv: %s/operator_trace.csv\n", options.output_dir);
    printf("operator_trace_summary_csv: %s/operator_trace_summary.csv\n", options.output_dir);
    printf("cycle_weight_timing_csv: %s/cycle_weight_timing.csv\n", options.output_dir);
